...
downloadButton.addEventListener('click', () => {
  ...
  a.href = url;
  a.download = mimeType === 'video/mp4' ? 'record-tool-file.mp4' : 'record-tool-file.webm';
...
async function startRecording() {
  ...
  if (mimeType.split(';', 1)[0] === 'video/mp4') {
    ...
    if (sampleRate != 48000) {
      ...
      const newStream = await navigator.mediaDevices.getdisplaymedia({audio: {sampleRate: 48000}});
